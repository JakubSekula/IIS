    ...
    <?php      
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td class='fas-td-arrow'><i class='fas fa-arrow-right' onclick=\"window.location.href='editor.php?type=User&id=".$row["id"]."'\"></i></td>";
                if($_SESSION['rights'] == 1)
     ...
     <?php      
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td class='fas-td-arrow'><i class='fas fa-arrow-right' onclick=\"window.location.href='editor.php?type=Hotel&id=".$row["hid"]."'\"></i></td>";
                echo "<td class='fas-td'><i class='fas fa-minus' onclick='delRow(this)'></i></td>";
                echo "</tr>";
            }
        }
