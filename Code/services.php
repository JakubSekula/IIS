...
class HotelService {
    ...
    // Returns all available equipment from all rooms in hotel with $hotel_id
    ...
    // Returns all available equipment in $room_type from $hotel_id
    ...
    // Returns avaiable equipment names (all from all hotels)
    ...
    // Print this message to index if no hotels were found
...
class UserService {
    ...
    // returns all reservations bounded with user_id. Returns true if record exists, false if it does not exists.
    ...
    // returns database row with user_id. Returns true if data exist, otherwise false
    ...
    // checks if user is employed at hotel. Returns true if record exists, false if it does not exists
    ...
    // returns true if user is owner of hotel, otherwise false
