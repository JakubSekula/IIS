...
$dateFrom = htmlspecialchars($_GET['fromDate']);
$dateTo = htmlspecialchars($_GET['toDate']);
...
for ($i = 0; $i < count($photos_paths); $i++) {
    ...
    // for ($j = 0; $j < 2; $j++) {
    //     $photo = $photos_paths[$i+$j];
    //     $photos .= "
    //         <div class=\"col\">
    //             <img src=\"$photo\" class=\"mimg mimg-fluid container-fluid no-padding\">
    //         </div>";
    // }
    ...
    <div class=\"container-fluid m-main\">
        ...
        <div class=\"mhotel-img-container\">
            <div class=\"mhotel-img\">
                <img src=\"$hotel_image\" class=\"mimg img-fluid container-fluid no-padding\">
            </div>
        </div>
